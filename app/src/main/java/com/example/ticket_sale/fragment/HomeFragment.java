...
//        getUpcomingMovieFromAPI();
    ...
    private void getCurrentMovieFromAPI(){
        ...
        homeViewModel.getTop6CurrentMovies().observe(getViewLifecycleOwner(), dataResult ->{
            ...
            if(currentMovies.size() > maxShowedMovie)   btnMoreMovies.setVisibility(View.VISIBLE);
        });
    }
    ...
    private void getUpcomingMovieFromAPI(){
        ...
        homeViewModel.getTop6UpcomingMovies().observe(getViewLifecycleOwner(), dataResult ->{
            ...
            pgbLoadMovies.setVisibility(View.GONE);
            if(upcomingMovies.size() > maxShowedMovie)
                btnMoreMovies.setVisibility(View.VISIBLE);
        });
    }
    ...
    private void setButtonListener(){
        ...
        btnUpcomingMovies.setOnClickListener(v -> {
            if(upcomingMovies == null || upcomingMovies.isEmpty()){
                ...
                btnMoreMovies.setVisibility(View.GONE);
                movieAdapter.setMovies(upcomingMovies);
                if(upcomingMovies.size() > maxShowedMovie)  btnMoreMovies.setVisibility(View.VISIBLE);
            }
        });
